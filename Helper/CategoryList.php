...
class CategoryList extends AbstractHelper
{
     ...
     */
    public function __construct(Context $context, CategoryCollectionFactory $categoryCollectionFactory)
    {
     ...
     */
    public function getList(bool $activeOnly = true, string $delimiter = '>', int $currentPage = 1, int $pageSize = 15): array
    {
        $categories = [];
